...
class SocialPostForm(forms.ModelForm):
    body = forms.CharField(widget=forms.Textarea(attrs={
            'class': 'mx-auto shadow-sm focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-300 dark:border-dark-third dark:text-dark-txt dark:placeholder-black flex max-w-full sm:text-sm border-gray-300 rounded-md',
            'rows': '3',
